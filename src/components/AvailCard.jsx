...
const AvailCard = ({ flight, getCode, getFlightDuration, formValue }) => {
  return (
    <div
      key={flight.id}
    ...
    >
      <div className="flex justify-between items-center pt-2">
        <h3 className="text-red-500 capitalize text-2xl">{flight.airline}</h3>
      ...
      <div className="flex justify-between mt-[3rem] text-gray-400">
        ...
        <div className="text-[11.5px] capitalize space-y-0 text-gray-400 flex flex-col items-end ">
          ...
          <p>
            ...
            {parseInt(flight.arivalTime.split(":")[0], 10) >= 12 ? "pm" : "am"}
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between pb-2">
        <p>
          {flight.cheap ? "Economy " : "Business class"} • {formValue.passenger}{" "}
